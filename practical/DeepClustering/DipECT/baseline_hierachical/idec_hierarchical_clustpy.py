...
from practical.DeepClustering.DipECT.baseline_hierachical.utils.dendrogram_purity import (
    dendrogram_purity, leaf_purity, to_dendrogram_purity_tree)
...
def run_idec_hierarchical(
    ...
    n_clusters,
    autoencoder,
    custom_dataloaders: Tuple[DataLoader, DataLoader],
    epochs=50,
    batch_size=256,
):
    ...
    idec.fit(
        custom_dataloaders[1].dataset.original_dataset
    )  # Expecting OriginalDataset class (see evaluation.py)
